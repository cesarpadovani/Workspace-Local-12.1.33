...
* Definir cùlulas String,Numùrica,data,DateTime,Logica,formula
* Adicionar novas planilhas(Nome,Cor)
* Cor de preenchimento(simples,efeito de preenchimento)
* Alinhamento(Horizontal,Vertical,Reduzir para Caber,Quebra Texto,Angulo de Rotaùùo)
* Formato da cùlula
* Mesclar cùlulas
* Auto Filtro
* hyperlink dentro da planilha
* Comentùrio
* Congelar painùis(colunas e linhas)
...
* Formataùùo condicional:(operador,formula)(font,fundo,bordas)
* Formatar como tabela(Estilos Predefinidos,Filtros,Totalizadores)
* Cria nome para referùncia de cùlula ou intervalo
* Agrupamento de linha e colunas
* Imagens
* Exibir/Oculta linhas de Grade
* Definir linha para repetir na impressùo
* Definir orientaùùo da pagina na impressùo
* Cabeùalho e Ropadù
* Leitura de dados jù gravados

* Leitura simples dos dados
@type class
@see https://github.com/saulogm/advpl-excel
@obs Office Open XML File Formats, sumario 1533
@obs para suporte ao libreOffice em servidor windows, instalar o 7Zip e apontar local da instalaùùo no INI do appserver (General/LOCAL7ZIP)
/*/
//Dummy Function
...
Class YExcel
	...
	Data adimension			//Dimensùo da planilha
	...
	METHOD SetPlanAt()		//Informa qual planilha estù em ediùùo
	METHOD GetPlanAt()		//Retorna qual planilha estù em ediùùo
	METHOD LenPlanAt()		//Quantidade de planilha
	//Controle de Cùlulas
	METHOD Cell()			//Grava as cùlulas
	METHOD Pos()			//posiciona na celula
	METHOD PosR()			//posiciona na celula de acordo com referùncia
	...
	METHOD ColTam()			//Coluna Mùnima e Mùxima
	METHOD LinTam()			//Linha Mùnima e Mùxima
	METHOD mergeCells()		//Mescla cùlulas
	...
	METHOD Ref()			//Passa a localizaùùo numerica e transforma em referencia da celula
	...
	METHOD AddNome()		//Cria nome para refencia de cùlula ou intervalo
	METHOD Addhyperlink()	//Cria um hyperlink para uma referùncia da planilha
	METHOD AddComment()		//Cria um comentùrio para a celula posicionada
	METHOD Alias2Tab()		//Preencher com alias informado
	
	METHOD InsertRowEmpty()	//Cria linhas vazia
	METHOD InsertCellEmpty()//Cria cùlulas vazias
	METHOD NivelLinha()
	...
	//Controle de layout, impressùo e pagina
	METHOD AddPane()		//Congelar Painùis
	METHOD showGridLines()	//Exibir ou ocultar linhas de grade
	METHOD SetPrintTitles()	//Configurar linha para repetir na impressùo
	METHOD SetPagOrientation()	//Configurar orientaùùo da pagina na impressùo
	Method SetHeader()		//Configurar Cabeùalho
	Method SetFooter()		//Configurar Rodapù
	...
	METHOD AddFormatCond()	//Formataùùo condicional(todos rercusos)
	METHOD Pane()			//Congelar Painùis
	...
	METHOD CreateStyle()	//Cria estilos com heranùa
	METHOD NewStyle()		//Cria estilos orientado a objeto
	METHOD AddStyles()		//Adiciona Estilos
	METHOD SetStyle()		//Informa o estilo em uma ou vùrias cùlula
	METHOD GetStyle()		//Retorna o estilo em uma cùlula
	METHOD Alinhamento()	//Adiciona alinhamento
	METHOD Borda()			//Adiciona borda(auxiliar)
	METHOD Border()			//Cria Borda com todas opùùes
	...
	//Formataùùo condicional
	METHOD FormatCond()		//Definir formataùùo condicional(auxiliar)
	...
	METHOD ADDdxf()			//Cria o estilo para formataùùo condicional
	...
	//deprecated
	METHOD SetDefRow()		//[deprecated]Defini as colunas da linha. Habilita a gravaùùo automatica de cada coluna. Importante para prover performace na gravaùùo de varias linhas
ENDCLASS
...
METHOD New(cNomeFile,cFileOpen,cTipo) Class YExcel
	...
	If !Empty(cFileOpen)
		...
		//Problema de nùo descompactar direto no servidor linux
		...
		nPos	:= ::new_rels("\tmpxls\"+::cTmpFile+'\'+::cNomeFile+"\_rels\.rels","\_rels\.rels")	//Arquivo nùo ù carregado pela funùùo Directory
		...
		//::add_rels(nPos,"http://schemas.openxmlformats.org/officeDocument/2006/relationships/sharedStrings","sharedStrings.xml")
		//Defini formato Moeda padrùo brasileiro
		::AddFmt('_-"R$"\ * #,##0.00_-;\-"R$"\ * #,##0.00_-;_-"R$"\ * "-"??_-;_-@_-',44)
	Endif

	//Cria conteudo padrùo
	::AddFont(11,"FF000000","Calibri","2")
	::Borda()	//Sem borda
	::CorPreenc(,,"none")
	::CorPreenc(,,"gray125")
	AADD(::aPadraoSty,::AddStyles(/*numFmtId*/,/*fontId*/,/*fillId*/,/*borderId*/,/*xfId*/,/*aValores*/,/*aOutrosAtributos*/))	//Sem Formataùùo
	AADD(::aPadraoSty,::AddStyles(14/*numFmtId*/,/*fontId*/,/*fillId*/,/*borderId*/,/*xfId*/,/*aValores*/,/*aOutrosAtributos*/))	//Formato Data padrùo
	AADD(::aPadraoSty,::AddStyles(::AddFmt("dd/mm/yyyy\ hh:mm AM/PM;@")/*numFmtId*/,/*fontId*/,/*fillId*/,/*borderId*/,/*xfId*/,/*aValores*/,/*aOutrosAtributos*/))	//Formato Data time padrùo
Return self
...
METHOD ADDPlan(cNome,cCor) Class YExcel
	...
	If nPos>0
		UserException("Esse nome de planilha jù foi usado!")
	Endif
...
Infoma a planilha de alteraùùo
@author Saulo Gomes Martins
@since 13/06/2020
...
Cria nome para refencia de cùlula ou intervalo
@author Saulo Gomes Martins
@since 09/05/2017
...
Informa a orientaùùo do papel na impressùo
@author Saulo Gomes Martins
@since 12/12/2019
@version 1.0
...
METHOD SetPagOrientation(cOrientation) Class YExcel
	...
	If lower(cOrientation)+"|" $ "default|landscape|portrait|"
		::cPagOrientation	:= cOrientation	//Proximas planilhas segue mesma orientaùùo
	Endif
...
Configurar o Cabeùalho
@type method
@version 1.0
@author Saulo Gomes Martins
@since 17/03/2021
@param cLeft, character, Texto seùùo da esquerda
@param cCenter, character, Texto seùùo central
@param cRight, character, Texto seùùo direita 
/*/
...
Definir tamanho padrùo da linha
@type method
@version 1.0
@author Saulo Gomes Martins
@since 14/09/2021
@param nHeight, numeric, tamanho da linha padrùo
/*/
...
@param cImg, characters, Localizaùùo da imagem
@type method
/*/
METHOD ADDImg(cImg) Class YExcel
	...
	If !File(cImg,,.F.)
		UserException("YExcel - Imagem nùo encontrada ("+cImg+")")
	Endif
...
@param cUnidade, characters, (opcional) Unidade da dimensùo da imagem. padrùo em pixel
@param nRot, numeric, rotaùùo da imagem
@type method
@OBS pag 3166
/*/
METHOD Img(nID,nLinha,nColuna,nX,nY,cUnidade,nRot) Class YExcel
	...
	If aScan(::aImagens,{|x| x[1]==nID })==0
		UserException("YExcel - Imagem nùo cadastrada, usar metodo ADDImg. ID("+cValToChar(nID)+")")
	Endif
	...
	//absolute	- Nùo mover ou redimensionar com linhas / colunas subjacentes
	//oneCell	- Mova-se com cùlulas, mas nùo redimensione
	//twoCell	- Mover e redimensionar com cùlulas ùncoras
...
/*/{Protheus.doc} Cell
Grava o conteudo de uma cùlula
@author Saulo Gomes Martins
@since 03/05/2017
@version p11
...
@param cFormula, characters, Formula da cùlula
@param nStyle, numeric, posiùùo do estilo criado pelo metodo :AddStyles()
@type method
/*/
METHOD Cell(nLinha,nColuna,xValor,cFormula,xStyle) Class YExcel
	...
	Endif
	If nColuna==0
		UserException("YExcel - O ùndice da coluna nùo pode iniciar no 0")
	Endif
	...
	ElseIf cTpStyle=="U" .AND. cTipo=="O".AND.GetClassName(xValor)=="YEXCEL_DATETIME" 	//Data e Date time, deixa formato padrùo, nùo limpa formato
	ElseIf cTpStyle!="U"
...
Method AddCol(nQtd,nColunaIni,nLinhaIni,nLinhaFim) Class YExcel
	...
	If ::lArquivo
		UserException("YExcel - Nùo ù possùvel adicionar colunas na criaùùo direta com arquivo")
	ElseIf ::lMemoria
		UserException("YExcel - Method nùo implementado. Nùo ù possùvel adicionar colunas na criaùùo em memoria")
	Else
...
Method AddRow(nQtd,nLinhaIni,nColunaIni,nColunaFim) Class YExcel
	...
	// 	nColunaIni	:= 1
	// Endif
	//Atualiza as cùlulas para nova posiùùo
	If ::lArquivo
		UserException("YExcel - Nùo ù possùvel adicionar linhas na criaùùo direta com arquivo")
	ElseIf ::lMemoria
		UserException("YExcel - Method nùo implementado. Nùo ù possùvel adicionar linhas na criaùùo em memoria")
	Else
...
Definir altura das llinhas. Se nùo enviado linha de/ate, considerar as prùximas linhas a ser criadas
@type method
@version 1.0
@author Saulo Gomes Martins
@since 06/07/2020
...
@param nLinha2, numeric, Opcional linha final para alteraùùo
/*/
Method SetRowH(nHeight,nLinha,nLinha2) Class YExcel
	...
	Else
		...
		//Inserir linhas que nùo existe para definir o tamanho
...
Alteraùùo de valores da cùlula posicionada
@type method
@version 1.0
@author Saulo Gomes Martins
@since 06/07/2020
...
Method SetValue(xValor,cFormula) Class YExcel
	...
	If ::lArquivo
		...
		ElseIf cTipo=="N"
			...
			::oC:AddValor(oTmpObj:GetTag())
		ElseIf cTipo=="D"
			//::SetAtributo("t","d")	//Adiciona o estilo padrùo de data
			...
			If ValType(nStyAtu)!="U" .AND. !::oStyle:XPathGetAtt("/xmlns:styleSheet/xmlns:cellXfs/xmlns:xf["+cValToChar(nStyAtu+1)+"]","applyNumberFormat")=="1"//!("D" $ ::StyleType((::cAliasCol)->STY))
				//Se tem estilo e ele nùo tem NumFmtId aplicado
				::oC:SetAtributo("s", ::CreateStyle(nStyAtu,14) )	//Cria um estilo com Numfmt data
			ElseIf ValType(nStyAtu)=="U"	//Nùo tem estilo
				::oC:SetAtributo("s",::aPadraoSty[2])	//Estilo padrùo de data
			Endif
		ElseIf cTipo=="O" .and. GetClassName(xValor)=="YEXCEL_DATETIME"
			...
			ElseIf ValType(nStyAtu)=="U"	//Nùo tem estilo
				::oC:SetAtributo("s",::aPadraoSty[3])	//Estilo padrùo de datetime
			Endif
		Else
			oTmpObj	:= YExcelTag():New("v",xValor)
			::oC:AddValor(oTmpObj:GetTag())
	...
	ElseIf ::lMemoria
		...
		If !::asheet[::nPlanilhaAt][1]:XPathHasNode("/xmlns:worksheet/xmlns:sheetData/xmlns:row[@r='"+cValToChar(::nLinha)+"']")
			...
			If ::nLinha<Val(cTmpVar)
				UserException("YExcel - Impossùvel criar linha("+::cRef+"). A ultima linha criado foi "+cTmpVar+". Seguir ordem crecente de criaùùo!")
			EndIf
			::asheet[::nPlanilhaAt][1]:XPathAddNode("/xmlns:worksheet/xmlns:sheetData","row","")
		...
		If !::asheet[::nPlanilhaAt][1]:XPathHasNode("/xmlns:worksheet/xmlns:sheetData/xmlns:row[@r='"+cValToChar(::nLinha)+"']/xmlns:c[@r='"+::cRef+"']")
			...
			If ::nColuna<::LocRef(cTmpVar)[2]
				UserException("YExcel - Impossùvel criar coluna("+::cRef+"). A ultima coluna criado foi "+cTmpVar+". Seguir ordem crecente de criaùùo!")
			EndIf
		...
		ElseIf cTipo=="D"
			...
			If ValType(cStyAtu)!="U" .AND. !::oStyle:XPathGetAtt("/xmlns:styleSheet/xmlns:cellXfs/xmlns:xf["+cValToChar(Val(cStyAtu)+1)+"]","applyNumberFormat")=="1"
	...
	Else
		...
		ElseIf cTipo=="D"
			...
			If (::cAliasCol)->STY>=0 .AND. !::oStyle:XPathGetAtt("/xmlns:styleSheet/xmlns:cellXfs/xmlns:xf["+cValToChar((::cAliasCol)->STY+1)+"]","applyNumberFormat")=="1"//!("D" $ ::StyleType((::cAliasCol)->STY))
				...
				(::cAliasCol)->TPSTY	:= "D"
			ElseIf (::cAliasCol)->STY<0	//Nùo tem estilo
				(::cAliasCol)->STY		:= ::aPadraoSty[2]	//Estilo padrùo de data
				(::cAliasCol)->TPSTY	:= "D"
			Endif
		ElseIf cTipo=="O" .and. GetClassName(xValor)=="YEXCEL_DATETIME"
			(::cAliasCol)->TIPO		:= "d"
			If (::cAliasCol)->STY>=0 .AND. ::oStyle:XPathGetAtt("/xmlns:styleSheet/xmlns:cellXfs/xmlns:xf["+cValToChar((::cAliasCol)->STY+1)+"]","applyNumberFormat")!="1"//!("D" $ ::StyleType((::cAliasCol)->STY))
				...
				(::cAliasCol)->TPSTY	:= "T"
			ElseIf (::cAliasCol)->STY<0	//Nùo tem estilo
				(::cAliasCol)->STY		:= ::aPadraoSty[3]	//Estilo padrùo de datetime
				(::cAliasCol)->TPSTY	:= "T"
			Endif
		Endif
...
Alteraùùo de data e hora da cùlula posicionada
@type method
@version 1.0
@author Saulo Gomes Martins
@since 30/03/2021
...
Method Pos(nLinha,nColuna,nPlanilha) Class YExcel
	...
	If ::lArquivo
		If ValType(::oC)=="O" .AND. (::nLinha<>nLinha .OR. ::nColuna<>nColuna)
			If nLinha<::nLinha
				UserException("YExcel - gravaùùo em arquivo deve ser sequencial. Linha Atual "+cValToChar(::nLinha)+" Linha enviada "+cValToChar(nLinha))
			ElseIf nLinha==::nLinha
				If nColuna<::nColuna
					UserException("YExcel - gravaùùo em arquivo deve ser sequencial. Coluna Atual "+cValToChar(::nColuna)+" Coluna enviada "+cValToChar(nColuna))
				EndIf
			EndIf
			::oC:GetTag(@::nFileTmpRow,.T.)
			FreeObj(::oC)
...
METHOD ColTam(nLinha,nLinha2)	Class YExcel		//Coluna Mùnima e Mùxima
	Local cQuery
	Local cAliasQry
	Local nMin		:= 0
	Local nMax		:= 0
	...
	If ::lMemoria
		...
		For nCont:=1 to Len(aChildren)
			...
			aRef	:= ::LocRef(cRef)
			nMin	:= Min(nMin,aRef[2])
			nMax	:= Max(nMax,aRef[2])
		Next*/
	Else
...
METHOD LinTam(nColuna,nColuna2)	Class YExcel		//Linha Mùnima e Mùxima
	Local cQuery
	Local cAliasQry
	//Local nCont
	//Local aChildren,aRef,cRef
	Local nMin			:= 1
	Local nMax			:= 1
	Default nColuna2	:= nColuna
	If ::lArquivo
	...
	If  ::lMemoria
		...
		For nCont:=1 to Len(aChildren)
			...
			If ValType(nColuna)=="N"
				...
				EndIf
			EndIf
			nMin	:= Min(nMin,aRef[1])
			nMax	:= Max(nMax,aRef[1])
		Next*/
	Else
		cAliasQry 	:= GetNextAlias()
...
Retorna o conteudo de uma cùlula
@author Saulo Gomes Martins
@since 03/05/2017
@version p11
@param nLinha, numeric, Linha a ser lida
@param nColuna, numeric, Coluna a ser lida
@param xDefault, variadic, Valor padrùo
@param lAchou, logical, se achou o conteudo
@type method
...
Method GetValue(nLinha,nColuna,xDefault,lAchou) Class YExcel
	...
	If ::lArquivo
		UserException("YExcel - Nùo ù possùvel usar o GetValue quando gravaùùo em arquivos. ")
	EndIf
	lAchou	:= .F.
	If ::lMemoria
		::asheet[::nPlanilhaAt][1]:ResetErrors()
...
Defini as colunas da linha. Habilita a gravaùùo automatica de cada coluna. Importante para prover performace na gravaùùo de varias linhas
@author Saulo Gomes Martins
@since 03/05/2017
@version p11
@param lHabilitar, logical, Habilita a definiùùo
...
Controla nùvel da estrutura de tùpicos das prùximas linhas criadas
@type method
@version 1.0
@author Saulo Gomes Martins
@since 06/07/2020
@param nNivel, numeric, Nùvel da linha
@param lFechado, logical, Se tem nùvel
...
Defini o nùvel das linhas informadas (agrupamento de linhas)
@type method
@version 1.0
@author Saulo Gomes Martins
@since 16/03/2021
@param nLinha, numeric, Linha inicial
@param nLinha2, numeric, Linha final
@param nNivel, numeric, Nùvel
@param lFechado, logical, Se esse nùvel estù fechado
/*/
Method SetRowLevel(nLinha,nLinha2,nNivel,lFechado) Class YExcel
	...
	PARAMTYPE 1	VAR lFechado	AS LOGICAL	OPTIONAL	DEFAULT	.F.
	If ::lArquivo
		UserException("YExcel - Nùo ù possùvel usar o SetRowLevel quando gravaùùo em arquivos. ")
	EndIf
...
Method mergeCells(nLinha,nColuna,nLinha2,nColuna2) Class YExcel
	...
	Local cStyAtu
	If nLinha2<nLinha
		UserException("YExcel - metodo mergeCells. Linha final nùo pode ser menor que linha inicial.")
	Endif
	If nColuna2<nColuna
		UserException("YExcel - metodo mergeCells. Coluna final nùo pode ser menor que Coluna inicial.")
	Endif
	cColuna		:= NumToString(nColuna)
	cColuna2	:= NumToString(nColuna2)
	...
	Next
	If nPos>0
		UserException("YExcel - metodo mergeCells. Cùlula "+cColuna+cValToChar(nLinha)+":"+cColuna2+cValToChar(nLinha2)+" nùo pode ser mesclada, essa cùlula jù foi mesclada!")
	Endif
	// If Empty(aChildren)
	...
	If !::lArquivo
		...
		Else
			If (::cAliasCol)->(DbSeek(Str(::nPlanilhaAt,10)+Str(nLinha,10)+Str(nColuna,10)))
				If (::cAliasCol)->STY>=0	//Replicar estilo da primeira cùlula
...
/*/{Protheus.doc} Font
Cria objeto de fonte para ser usado na criaùùo de estilos para formataùùo condicional
@author Saulo Gomes Martins
@since 03/05/2017
@version p11
...
/*/{Protheus.doc} Preenc
Cria objeto de preenchimento para ser usado na criaùùo de estilos para formataùùo condicional
@author Saulo Gomes Martins
@since 03/05/2017
@version p11
...
@param cType, characters, (Opcional) tipo de preenchimento(padrùo solid)
@type method
/*/
...
Cria objeto de bordas para ser usado na criaùùo de estilos para formataùùo condicional
@author Saulo Gomes Martins
@since 03/05/2017
@version p11
...
/*/{Protheus.doc} ADDdxf
Cria estilo para formataùùo condicional
@author Saulo Gomes Martins
@since 03/05/2017
@version p11
...
@return numeric, posiùùo do estilo
@type method
/*/
...
Cria uma regra para formataùùo condicional
@author Saulo Gomes Martins
@since 03/05/2017
@version p11
@param cRefDe, characters, Rerefencia inicial (Exemplo "A1")
@param cRefAte, characters, Referencia final (Exemplo "A10")
@param nEstilo, numeric, posiùùo do estilo criado pelo metodo :ADDdxf()
@param operator, object, Operado da regra. veja observaùùes
...
@obs operadores
	...
	$		contem texto
	!$		nùo contem
	between	esta contido(enviar no parametro xformula um array com duas posiùùes)
...
METHOD FormatCond(cRefDe,cRefAte,nEstilo,operator,xFormula) Class YExcel
	...
	*/
	...
	If operator=="between"	.and. (ValType(xFormula)<>"A" .or. Len(xFormula)<2)
		UserException("YExcel - operador between ù necessario informar valor de, ate. Enviar parametro 5 xformula como array(2).")
	Endif
	If operator=="FORMULA"
...
Adiciona fonte para ser usado no estilo das cùlulas
@author Saulo Gomes Martins
@since 03/05/2017
@version p11
@param nTamanho, numeric, (Opcional) Tamanho da fonte
...
@param lSublinhado, logical, (Opcional) Soblinhado
@param lTachado, logical, (Opcional) Tachado
@return numeric, posiùùo da fonte
@type method
/*/
...
Adiciona cor de preenchimento para ser usado no estilo das cùlulas
@author Saulo Gomes Martins
@since 03/05/2017
@version p11
@param cBgCor, characters, (Opcional) Cor em Alpha+RGB do preenchimento
...
@param nleft, numeric, (Opcional) para efeito path posiùùo esquerda
@param nright, numeric, (Opcional) para efeito path posiùùo direita
@param ntop, numeric, (Opcional) para efeito path posiùùo topo
@param nbottom, numeric, (Opcional) para efeito path posiùùo inferior
@return numeric, Posiùùo para criaùùo de estilo
@type method
/*/
...
METHOD gradientFill(nAngulo,aCores,ctype,nleft,nright,ntop,nbottom,cLocal) Class YExcel	//Pag 1779
	...
	If ValType(ctype)!="U" .and. ctype=="path"
		...
		If ValType(nleft)!="N" .OR. !(nleft>=0 .and. nleft<=1)
			UserException("YExcel - definir posiùùo left em 0 a 1. Valor informado:"+cValToChar(nleft))
		Endif
		If ValType(nright)!="N" .OR. !(nright>=0 .and. nright<=1)
			UserException("YExcel - definir posiùùo right em 0 a 1. Valor informado:"+cValToChar(nright))
		Endif
		If ValType(ntop)!="N" .OR. !(ntop>=0 .and. ntop<=1)
			UserException("YExcel - definir posiùùo top em 0 a 1. Valor informado:"+cValToChar(ntop))
		Endif
		If ValType(nbottom)!="N" .OR. !(nbottom>=0 .and. nbottom<=1)
			UserException("YExcel - definir posiùùo bottom em 0 a 1. Valor informado:"+cValToChar(nbottom))
		Endif
	...
	For nCont:=1 to Len(aCores)
		If !(aCores[nCont][2]>=0 .and. aCores[nCont][2]<=1)
			UserException("YExcel - Definiùùo de cor varia de 0 a 1. Valor informado:"+cValToChar(aCores[nCont][2]))
		Endif
...
/*/{Protheus.doc} Borda
Cria borda para ser usado no estilo das cùlulas
@author Saulo Gomes Martins
@since 03/05/2017
@version p11
@param cTipo, characters, "C"-Cima|"B"-Baixo|"E"-Esquerda|"D"-Direita|T-TODAS("CBED") OU "T"-TOP|"B"-Bottom|"L"-Left|"R"-Right|A-ALL("TBLR") OU "DIAGONAL"-Diagonal
...
@param lAdd, logical, deve criar o objeto como estilo de cùlula. Padrùo .T.
...
@param nNumFmtId, numeric, numFmtId para alteraùùo
@type method
@example |
...
Method AddFmtNum(nDecimal,lMilhar,cPrefixo,cSufixo,cNegINI,cNegFim,cValorZero,cCor,cCorNeg,nNumFmtId) Class YExcel
	...
	If !Empty(cCor)
		If ValType(cCor)=="C"
			...
			If nPosCor==0
				UserException("YExcel - Cor da formataùùo invalida ("+cCor+")")
			Else
				cCor	:= aCores[nPosCor]
			Endif
		ElseIf ValType(cCor)=="N"
			If !(cCor>=1 .AND. cCor<=56)
				UserException("YExcel - Cor da formataùùo invalida ("+cValToChar(cCor)+"), Cores indexado valido de 1-56.")
			Endif
	...
	If !Empty(cCorNeg)
		If ValType(cCorNeg)=="C"
			...
			If nPosCor==0
				UserException("YExcel - Cor da formataùùo invalida ("+cCorNeg+")")
			Else
				cCorNeg	:= aCores[nPosCor]
			Endif
		ElseIf ValType(cCorNeg)=="N"
			If !(cCorNeg>=1 .AND. cCorNeg<=56)
				UserException("YExcel - Cor da formataùùo invalida ("+cValToChar(cCorNeg)+"), Cores indexado valido de 1-56.")
			Endif
...
Return nNumFmtId	//Nùo retorna a posiùùo, mas o atributo numFmtId
...
Method AddFmt(cformatCode,nNumFmtId) Class YExcel
	...
	If Empty(nNumFmtId)
		...
		nNumFmtId	:= ::nNumFmtId++
	Endif
	If !::oStyle:XPathHasNode( "/xmlns:styleSheet/xmlns:numFmts/xmlns:numFmt[@numFmtId='"+cValToChar(nNumFmtId)+"']")	//Se nùo existe o ID
...
Cria um estilo para ser usado nas cùlulas
@author Saulo Gomes Martins
@since 03/05/2017
@version p11
@param numFmtId, numeric, numero com formato da cùlula. ver em observaùùes
@param fontId,numeric, posiùùo da fonte criado pelo metodo :AddFont()
@param fillId, numeric, posiùùo do preenchimento criado pelo metodo :CorPreenc()
@param borderId, numeric, posiùùo da borda criado pelo metodo :Borda()
@param xfId, numeric, posiùùo dos estilos padrùes. nùo usado(uso futuro)
...
METHOD AddStyles(numFmtId,fontId,fillId,borderId,xfId,aValores,aOutrosAtributos) Class YExcel
	...
	If ValType(fontId)=="N" .AND. (fontId+1)>Val(::oStyle:XPathGetAtt("/xmlns:styleSheet/xmlns:fonts","count"))
		UserException("YExcel - Fonte informada("+cValToChar(fontId)+") nùo definido. Utilize o indice informado pelo metodo :AddFont()")
	ElseIf ValType(fillId)=="N" .AND. (fillId+1)>Val(::oStyle:XPathGetAtt("/xmlns:styleSheet/xmlns:fills","count"))
		UserException("YExcel - Cor Preenchimento informado("+cValToChar(fillId)+") nùo definido. Utilize o indice informado pelo metodo :CorPreenc()")
	ElseIf ValType(borderId)=="N" .AND. (borderId+1)>Val(::oStyle:XPathGetAtt("/xmlns:styleSheet/xmlns:borders","count"))
		UserException("YExcel - Borda informada("+cValToChar(borderId)+") nùo definido. Utilize o indice informado pelo metodo :Borda()")
	Endif
...
Method SetnumFmt(numFmtId,lProprio) Class YExcel_Style
	Local nCont
	Default lProprio	:= .T.	//Se .T. ù um estilo proprio, se nùo ù do pai 
	If lProprio
		::numFmtId	:= numFmtId
	Endif
	If ValType(::nStyle)!="U"	//Se jù criou o estilo, modifica
		// ::oExcel:SetStyFmt(::nStyle,numFmtId)
		::nStyle	:= nil
	Endif
	For nCont:=1 to Len(::aFilhos)	//Passa a heranùa para frente se foi herdada
		If ValType(::aFilhos[nCont]:numFmtId)=="U" .AND.ValType(::aFilhos[nCont]:nStyle)!="U"	//Se o filho nùo tem formato proprio(herdou do pai)
...
Method Setfont(fontId,lProprio) Class YExcel_Style
	...
	Endif
	For nCont:=1 to Len(::aFilhos)	//Passa a heranùa para frente se foi herdada
		If ValType(::aFilhos[nCont]:fontId)=="U" .AND.ValType(::aFilhos[nCont]:nStyle)!="U"	//Se o filho nùo tem formato proprio(herdou do pai)
...
Method Setfill(fillId,lProprio) Class YExcel_Style
	...
	Endif
	For nCont:=1 to Len(::aFilhos)	//Passa a heranùa para frente se foi herdada
		If ValType(::aFilhos[nCont]:fillId)=="U" .AND.ValType(::aFilhos[nCont]:nStyle)!="U"	//Se o filho nùo tem formato proprio(herdou do pai)
...
Method Setborder(borderId,lProprio) Class YExcel_Style
	...
	Endif
	For nCont:=1 to Len(::aFilhos)	//Passa a heranùa para frente se foi herdada
		If ValType(::aFilhos[nCont]:borderId)=="U" .AND.ValType(::aFilhos[nCont]:nStyle)!="U"	//Se o filho nùo tem formato proprio(herdou do pai)
...
Method SetxfId(xfId,lProprio) Class YExcel_Style
	...
	Endif
	For nCont:=1 to Len(::aFilhos)	//Passa a heranùa para frente se foi herdada
		If ValType(::aFilhos[nCont]:xfId)=="U" .AND.ValType(::aFilhos[nCont]:nStyle)!="U"	//Se o filho nùo tem formato proprio(herdou do pai)
...
Method SetaValores(aValores,lProprio) Class YExcel_Style
	...
	Endif
	For nCont:=1 to Len(::aFilhos)	//Passa a heranùa para frente se foi herdada
		If ValType(::aFilhos[nCont]:aValores)=="U" .AND.ValType(::aFilhos[nCont]:nStyle)!="U"	//Se o filho nùo tem formato proprio(herdou do pai)
...
Method SetAtt(aOutrosAtributos,lProprio) Class YExcel_Style
	...
	Endif
	For nCont:=1 to Len(::aFilhos)	//Passa a heranùa para frente se foi herdada
		If ValType(::aFilhos[nCont]:aOutrosAtributos)=="U" .AND.ValType(::aFilhos[nCont]:nStyle)!="U"	//Se o filho nùo tem formato proprio(herdou do pai)
...
Adiciona estilo com heranùa de outro estilo
@type method
@version 1.0
@author Saulo Gomes Martins
@since 26/06/2020
@param nStyle, numeric, Estilo para ser usado como heranùa
@return numeric, nPos posiùùo do estilo criado
/*/
...
Alterar Fmt do estilo jù criado
@type method
@version 1.0
@author Saulo Gomes Martins
@since 27/06/2020
...
Method SetStyFmt(nStyle,numFmtId) Class YExcel
	...
	If nStyle+1>::nQtdStyle
		UserException("YExcel - Estilo informado("+cValToChar(nStyle)+") nùo definido. Utilize o indice informado pelo metodo AddStyles")
	Endif
...
Alterar a fonte do estilo jù criado
@type method
@version 1.0
@author Saulo Gomes Martins
@since 27/06/2020
...
Alterar preenchimento de fundo do estilo jù criado
@type method
@version 1.0
@author Saulo Gomes Martins
@since 27/06/2020
...
Alterar a borda do estilo jù criado
@type method
@version 1.0
@author Saulo Gomes Martins
@since 27/06/2020
...
Alterar xf do estilo jù criado
@type method
@version 1.0
@author Saulo Gomes Martins
@since 27/06/2020
...
Alterar aValores estilo jù criado
@type method
@version 1.0
@author Saulo Gomes Martins
@since 27/06/2020
...
Alterar aOutrosAtributos estilo jù criado
@type method
@version 1.0
@author Saulo Gomes Martins
@since 27/06/2020
...
Method CreateStyle(nStyle,numFmtId,fontId,fillId,borderId,xfId,aValores,aOutrosAtributos) Class YExcel
	...
	Local aChildren
	Local nCont
	If ValType(nStyle)=="U"	//Cria estilo sem heranùa
...
Cria regras de estilo e formataùùo
@type method
@version 1.0
@author Saulo Gomes Martins
@since 04/07/2020
@return object, Objeto para criar regras de formataùùo
/*/
...
Method GetStyle(nLinha,nColuna) Class YExcel_StyleRules
	...
	For nCont:=1 to Len(::aStyles)
		...
		Endif
	Next
	oStyle	:= YExcel_Style():New(oStyle,::oExcel)	//::oExcel:NewStyle(oStyle)	//Cria um estilo novo com heranùa para evitar modificaùùo do principal
...
Method GetId(nLinha,nColuna) Class YExcel_StyleRules
	...
	//Apùs pegar o ID libera objeto criado da memoria
...
Method AddStyle(bRule,xStyle) Class YExcel_StyleRules
	...
	If ValType(xStyle)=="N" .and. xStyle>=0 .AND. xStyle+1>::oExcel:nQtdStyle
		UserException("YExcel - Estilo informado("+cValToChar(xStyle)+") nùo definido. Utilize o indice informado pelo metodo AddStyles")
...
Altera o estilo de uma ou vùrias cùlulas
@author Saulo Gomes Martins
@since 18/06/2020
@version 2.0
@param xStyle, variadic, (numeric/Array) posiùùo do estilo criado pelo metodo :AddStyles()
...
METHOD SetStyle(xStyle,nLinha,nColuna,nLinha2,nColuna2) Class YExcel
	...
	If ::lArquivo
		If nLinha<>nLinha2 .OR. nColuna<>nColuna2
			UserException("YExcel - Nùo permitido alteraùùo de estilos de varias linhas quando criaùùo em arquivo!")
		EndIf
		If nLinha<>::nLinha .OR. nColuna<>::nColuna
			UserException("YExcel - Nùo permitido alteraùùo de fora do posicionamento quando criaùùo em arquivo!")
		EndIf
	EndIf
	...
	If cTpAlte!="U" .AND. !::lArquivo
		::InsertCellEmpty(nLinha,nColuna,nLinha2,nColuna2)	//Inserir as celulas vazias que nùo tem dados para preencher o estilo
	EndIf
	If cTpAlte=="N"	//Alteraùùo direta de estilo
		lNumFmtId := ::oStyle:XPathGetAtt("/xmlns:styleSheet/xmlns:cellXfs/xmlns:xf["+cValToChar(xStyle+1)+"]","applyNumberFormat")=="1"	//Tem formataùùo definida
		If lNumFmtId
		...
		Else
			If ::lArquivo
				...
				If ValType(nStyAtu)<>"U"
					...
					Else	//Para os que nùo tem fmtid definido, aplica o estilo enviado
						nStyletmp	:= xStyle
					EndIf
				EndIf
			...
			ElseIf ::lMemoria
				...
				For nCont:=1 to Len(aChildren)
					...
					nStyletmp	:= xStyle
					If !Empty(cStyAtu)
						lnumFmtId	:= ::oStyle:XPathGetAtt("/xmlns:styleSheet/xmlns:cellXfs/xmlns:xf["+cValToChar(Val(cStyAtu)+1)+"]","applyNumberFormat")=="1"
						If lnumFmtId	//Tem fmtid
		...
		ElseIf ::lMemoria
			...
			For nCont:=1 to Len(aChildren)
				...
				If !Empty(cStyAtu)
					lnumFmtId	:= ::oStyle:XPathGetAtt("/xmlns:styleSheet/xmlns:cellXfs/xmlns:xf["+cValToChar(Val(cStyAtu)+1)+"]","applyNumberFormat")=="1"
					If lnumFmtId	//Tem fmtid
						nNumFmtId	:= Val(::oStyle:XPathGetAtt("/xmlns:styleSheet/xmlns:cellXfs/xmlns:xf["+cValToChar(Val(cStyAtu)+1)+"]","numFmtId"))
			...
			For nLin:=nLinha to nLinha2				//Ler as Linhas
				For nCol:=nColuna to nColuna2		//Ler as colunas
					...
					If (::cAliasCol)->(DbSeek(Str(::nPlanilhaAt,10)+Str(nLin,10)+Str(nCol,10)))
						//Se nùo tem fmrid no estilo da regra e tem no estilo atual 
...
Retorna o estilo de uma cùlulas
@author Saulo Gomes Martins
@since 18/06/2020
@version 2.0
@param nLinha, numeric, Linha inicial a ser alterada
...
Cria objeto de alinhamento da cùlula para ser usado na criaùùo de estilo
@author Saulo Gomes Martins
@since 03/05/2017
@version p11
...
@param ntextRotation, numeric, Graus para rotaùùo
@type method
@obs	HORIZONTAL
	center
	centerContinuous
...
METHOD Alinhamento(cHorizontal,cVertical,lReduzCaber,lQuebraTexto,ntextRotation) Class YExcel
	...
	If lReduzCaber .and. !lQuebraTexto
		oAlinhamento:SetAtributo("shrinkToFit","1")	//Um valor booleano que indica se o texto exibido na cùlula deve ser encolhido para se ajustar ù cùlula
	Endif
	If lQuebraTexto
		oAlinhamento:SetAtributo("wrapText","1")	//Um valor booleano indicando se o texto em uma cùlula deve ser envolvido na linha dentro da cùlula.
	Endif
Return oAlinhamento
...
METHOD Pane(cActivePane,cState,cRef,nySplit,nxSplit) Class YExcel
	...
	EndIf
	/*
	bottomLeft	- Painel inferior esquerdo, quando ambos verticais e horizontais sùo aplicadas. Esse valor tambùm ù usado quando apenas uma divisùo horizontal foi aplicada, dividindo o painel em superior e inferior. Nesse caso, esse valor especifica painel inferior
	bottomRight - Painel inferior direito, quando as divisùes verticais e horizontais sùo aplicadas.
	topLeft		- Painel superior esquerdo, quando as divisùes verticais e horizontais sùo aplicadas.
	topRight	- Painel superior direito, quando as divisùes verticais e horizontais sùo aplicadas
	*/
	SetAtrr(::asheet[::nPlanilhaAt][1],"/xmlns:worksheet/xmlns:sheetViews/xmlns:sheetView/xmlns:pane[last()]", "activePane"	, cActivePane )
	/*
	frozen		- Panes sùo congelados, mas nùo foram divididos sendo congelados. Nesse estado, quando os painùis sùo desbloqueados novamente, um ùnico painel resulta, sem divisùo. Nesse estado, as barras de divisùo nùo sùo ajustùveis.
	frozenSplit	- Os painùis sùo congelados e foram divididos antes de serem congelados. Neste estado, quando os painùis sùo desbloqueados novamente, a divisùo permanece, mas ù ajustùvel.
	split		- Os painùis sùo divididos, mas nùo congelados. Nesse estado, as barras de divisùo sùo ajustùveis pelo usuùrio.
	*/
	SetAtrr(::asheet[::nPlanilhaAt][1],"/xmlns:worksheet/xmlns:sheetViews/xmlns:sheetView/xmlns:pane[last()]", "state"	, cState )
	//Localizaùùo da cùlula visùvel superior esquerda no painel inferior direito (quando no modo Esquerdo para Direito).
	SetAtrr(::asheet[::nPlanilhaAt][1],"/xmlns:worksheet/xmlns:sheetViews/xmlns:sheetView/xmlns:pane[last()]", "topLeftCell"	, cRef )
	//Posiùùo horizontal da divisùo, em 1/20ù de um ponto; 0 (zero) se nenhum. Se o painel estiver congelado, este valor indica o nùmero de colunas visùveis no painel superior
	SetAtrr(::asheet[::nPlanilhaAt][1],"/xmlns:worksheet/xmlns:sheetViews/xmlns:sheetView/xmlns:pane[last()]", "xSplit"	, cValToChar(nxSplit) )
	//Posiùùo vertical da divisùo, em 1/20ù de um ponto; 0 (zero) se nenhum. Se o painel estiver congelado, este valor indica o nùmero de linhas visùveis no painel esquerdo.
...
Cria um hyperlink para uma referùncia da planilha
@type method
@version 1.0
@author Saulo Gomes Martins
@since 18/03/2021
@param cLocation, character, Referùncia, pode ser simple (A1) ou intervalo (A1:C3)
@param ctooltip, character, Texto de dica ao passar mouse por cima
@param cDisplay, character, Texto de exibiùùo na celula
@return object, self
/*/
...
Adicionar comentùrio
@type method
@version 1.0
@author Saulo Gomes Martins
@since 18/03/2021
@param cText, character, Texto do comentùrio
@param cAutor, character, Autor do comentùrio
@return object, self
@obs pag 4682
/*/
METHOD AddComment(cText,cAutor,nleft,ntop) Class YExcel
	...
	If Empty(cText)
		...
		Endif
	Else
		//Cria a forma do comentùrio se nùo existe
		...
		If !::asheet[::nPlanilhaAt][5]:XPathHasNode('/xml/v:shape[x:ClientData/x:Row="'+cValToChar(::nLinha-1)+'" and x:ClientData/x:Column="'+cValToChar(::nColuna-1)+'"]')
			//posiùùo da forma de acordo com posiùùo da cùlula
				...
				Else
					...
					If (cAliasQry)->(!EOF())
						...
						If (::nLinha-1)>nQtdLinhas
							//Adiciona as linhas que nùo tem conteudo o tamanho padrùo
...
/*/{Protheus.doc} Ref
Retorna a referencia do excel de acordo com posiùùo da linha e coluna em formato numerico
@author Saulo Gomes Martins
@since 03/05/2017
@version p11
...
/*/{Protheus.doc} LocRef
Retorna linha e coluna de acordo com informaùùo da referencia
@author Saulo Gomes Martins
@since 03/03/2018
@version 1.0
@return array, aLinhaCol Array com duas dimenùùes 1=Linha|2=Coluna
...
Retorna a letra da coluna de acordo com a posiùùo numerica
@author Saulo Gomes Martins
@since 03/05/2017
@version p11
...
Retorna a posiùùo da coluna de acordo com a letra da coluna
@author Saulo Gomes Martins
@since 03/05/2017
@version p11
...
Adiciona tabela com formataùùo
@author Saulo Gomes Martins
@since 08/05/2017
...
@param lDelSrv, logical, Deleta a planilha apùs copiar para o client
...
Method Save(cLocal) Class YExcel
	...
	For nCont:=1 to Len(::asheet)
		...
		If !::lMemoria
			...
			nBytesFalta := nTamArquivo			//Define que a quantidade que falta copiar ù o prùprio tamanho do Arquivo
			...
			While nBytesFalta > 0
					...
					Else
						...
						While (::cAliasLin)->(!EOF()) .and. nCont==(::cAliasLin)->PLA
							...
							While (::cAliasCol)->(!EOF()) .AND. nCont==(::cAliasCol)->PLA .AND. nLinha==(::cAliasCol)->LIN
								...
								ElseIf !Empty((::cAliasCol)->TIPO) .AND. (::cAliasCol)->TPVLR!="U" .AND. !( ((::cAliasCol)->TIPO =="d".AND.(::cAliasCol)->TPVLR=="N") .OR. (::cAliasCol)->TIPO =="n" )	//nùo incluir atributo "t" quando data serializada e numero
				...
				If nBytesSalvo < nBytesLer
					UserException("Erro de gravaùùo do Destino. " + Str(nBytesLer,8,2) +;
	...
	cNome	:= SubStr(cArquivo,Rat("\",cArquivo)+1)	//Split nùo estù respeitando o case original
	If !Empty(cPath)
		FWMakeDir(cPath,.F.)	//Cria a estrutura de pastas
	Endif

	If IsSrvUnix()	//Soluùùo para servidor linux zipar arquivos com inicio "."
...
//	oFile:Close()
	...
	fClose(nFile)
Return lOk
//NùO DOCUMENTAR, USADO NA GRAVAùùO DO SHEET
...
Defini o nùvel das colunas informadas (agrupamento de colunas)
@type method
@version 1.0
@author Saulo Gomes Martins
@since 16/03/2021
...
Return
/*/{Protheus.doc} ColNew
Cria uma nova definiùùo de coluna ou usa a jù existente
@type function
@version 1.0
@author Saulo Gomes Martins
@since 16/03/2021
...
Ajusta conflito de coluna entre min e max antes de incluir definiùùo
@type function
@version 1.0
@author Saulo Gomes Martins
@since 16/03/2021
...
@param cFile, characters, arquivo que serù aberto
...
METHOD OpenRead(cFile,nPlanilha) Class YExcel
	...
	If !File("\tmpxls\"+::cTmpFile+"\"+::cNomeFile+"\xl\worksheets\sheet"+cValTochar(nPlanilha)+".xml",,.F.)
		...
		cNome	:= SubStr(cFile,Rat("\",cFile)+1)	//Split nùo estù respeitando o case original
		FWMakeDir("\tmpxls\"+::cTmpFile+'\',.F.)
		FWMakeDir("\tmpxls\"+::cTmpFile+'\'+::cNomeFile+'\',.F.)
		If ":" $ UPPER(cFile)
...
Retorna o valor de uma celula, apùs o uso do mùtodo OpenRead()
@author Saulo Gomes Martins
@since 03/03/2018
@version 1.0
@return variadic, xValor Conteùdo da celula
@param nLinha, numeric, Linha da informaùùo
@param nColuna, numeric, Coluna da informaùùo
@param xDefault, variadic , Valor padrùo caso nùo tenha a informaùùo
@param lAchou, logical, passa por referencia se achou a informaùùo da celula
@type method
/*/
...
Method GetTag(nFile,lFechaTag,lSoValor) Class YExcelTag
	...
	Default lFechaTag	:= .T.
	Default lSoValor	:= .F.
	If ValType(nFile)<>"U"	//Gravaùùo direto no arquivo
		If lSoValor
...
CLASSE PARA CRIAùùO DE TABELAS PARA A CLASSE YEXCEL
@author Saulo Gomes Martins
@since 08/05/2017
...
/*/{Protheus.doc} Cell
Preenche informaùùo da cùlula
@author Saulo Gomes Martins
@since 08/05/2017
@version undefined
@param cColuna, characters, Nome da coluna
@param xValor, variadic, conteudo da cùlula
@param cFormula, characters, (Opcional) Formula
@param nStyle, numeric, (Opcional) posiùùo da formataùùo
@type method
/*/
METHOD Cell(cColuna,xValor,cFormula,nStyle) Class YExcel_Table
	...
	If ValType(cColuna)=="C"
		If !::oColunas:Get(cColuna,@aColuna)
			UserException("YExcel - Coluna informada nùo encontrado. Utilize o metodo AddColumn para adicionar a coluna:"+cValToChar(cColuna))
		Endif
		nColuna	:= aColuna[2]
		If Empty(nStyle)
			nStyle	:= aColuna[5]
...
@author Saulo Gomes Martins
@since 08/05/2017
@param nQtd, numeric, Quantidade de linhas para avanùar
@type method
/*/
...
Retorna objeto para manipulaùùo de DateTime
@author Saulo Gomes Martins
@since 09/12/2019
@version 1.0
@param dData, date, Data para formataùùo
@param cTime, characters, Hora para formataùùo
...
Classe yExcel_DateTime para manipulaùùo de DateTime
@author Saulo Gomes Martins
@since 10/12/2019
@version 1.0
@obs pag 4780
...
Class YExcel_DateTime
	...
	Data nDecimal			//Numero com limite decimal acima de 8 posiùùes
	Data cClassName			//Nome da Classe
	Data cName				//Nome da Classe
	Method New() CONSTRUCTOR
	METHOD ClassName()
...
@since 10/12/2019
@version 1.0
@param nData, numeric, numero da hora, aceita tambùm string
@type method
/*/
...
@since 09/12/2019
@version 1.0
@return Array, aHora 1-Hora|2-Munuto|3-Segundo|4-Milùsimo de segundo
...
Static Function SeparaHora(cHora)
	...
	Local nMinutos	:= 0
	Local nSegundos	:= 0
	Local nMilesimo	:= 0	//Milùsimo de segundo
	Local nPosSepara
...
Criaùùo do arquivo \[content_types].xml
@author Saulo Gomes Martins
@since 10/12/2019
@version 1.0
@param cXml, characters, xml para criaùùo
@type method
/*/
...
@since 10/12/2019
@version 1.0
@return numeric, nPos Posiùùo no array
@param cXml, characters, xml para criaùùo
...
@since 10/12/2019
@version 1.0
@return numeric, nPos posiùùo do draw no array
@param cXml, characters, xml para leitura
...
@param cText2, characters, texto com node para correùùo
@type function
/*/
...
Method xls_sheet(cFile,cCaminho) Class YExcel
	...
	Else
		oXML:ParseFile(cFile)
		//oXML:Parse(AjusEncode(oXML:Save2String()))
	Endif
...
@return numeric, Posiùùo da ordem
/*/
...
@param cPath, character, Caminho do nù que serù enviado
@param cFiltro, character, Envia apenas tags do filtro
@param cNaoFazer, character, Nùo envia determinada Tag
@param lAdd, logical, Incluir direto a tag ou analisa se jù existe
...
Cria o caminho completo, a funùùo padrùo nùo mantem o case
@type function
@version 1.0
@author Saulo Gomes Martins
@since 17/03/2021
@param cCaminho, character, Caminho
@param lShowMsg, logical, nùo usado
/*/
...
Static Function PlainH_1()
	...
	cRet += '		<a:clrScheme name="Escritùrio">' + CHR(13)+CHR(10)
...
Static Function PlainH_2()
	...
	cRet += '		<a:fontScheme name="Escritùrio">' + CHR(13)+CHR(10)
...
Static Function PlainH_4()
	...
	cRet += '		<a:fmtScheme name="Escritùrio">' + CHR(13)+CHR(10)
...
*/
Class YExcelVar
	Data cTipo				//T=TEXTO;N=NUMERO;L=LOGICO;R=REFERENCIA;F=FUNùùO;E=EXPRESSùO
	Data xValor				//VALOR
	Data cFuncao			//Nome da funùùo
