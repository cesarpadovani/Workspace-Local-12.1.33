...
Gerado em        19/05/23 09:45:20
Observa��es      C�digo-Fonte gerado por ADVPL WSDL Client 1.120703
                 Altera��es neste arquivo podem causar funcionamento incorreto
                 e ser�o perdidas caso o c�digo-fonte seja gerado novamente.
=============================================================================== */

User Function _EDOMSND ; Return  // "dummy" function - Internal Use 
...
WSCLIENT WSCalcPrecoPrazoWS
	...
	WSDATA   cstrVerificaRestricao     AS string
	WSDATA   oWScalcPrazoNovoResult    AS CalcPrecoPrazoWS_cResultado
...
WSMETHOD INIT WSCLIENT WSCalcPrecoPrazoWS
	...
	::oWScalcPrazoNovoResult := CalcPrecoPrazoWS_CRESULTADO():New()
Return
...
WSMETHOD RESET WSCLIENT WSCalcPrecoPrazoWS
	...
	::cstrVerificaRestricao := NIL 
	::oWScalcPrazoNovoResult := NIL 
	::Init()
Return
...
Local oClone := WSCalcPrecoPrazoWS():New()
	...
	oClone:cstrVerificaRestricao := ::cstrVerificaRestricao
	oClone:oWScalcPrazoNovoResult :=  IIF(::oWScalcPrazoNovoResult = NIL , NIL ,::oWScalcPrazoNovoResult:Clone() )
Return oClone
...
// WSDL Method calcPrazoNovo of Service WSCalcPrecoPrazoWS

WSMETHOD calcPrazoNovo WSSEND cnCdServico,csCepOrigem,csCepDestino,csDtCalculo,cstrVerificaRestricao WSRECEIVE oWScalcPrazoNovoResult WSCLIENT WSCalcPrecoPrazoWS
Local cSoap := "" , oXmlRet

BEGIN WSMETHOD

cSoap += '<calcPrazoNovo xmlns="http://tempuri.org/">'
cSoap += WSSoapValue("nCdServico", ::cnCdServico, cnCdServico , "string", .F. , .F., 0 , NIL, .F.,.F.) 
cSoap += WSSoapValue("sCepOrigem", ::csCepOrigem, csCepOrigem , "string", .F. , .F., 0 , NIL, .F.,.F.) 
cSoap += WSSoapValue("sCepDestino", ::csCepDestino, csCepDestino , "string", .F. , .F., 0 , NIL, .F.,.F.) 
cSoap += WSSoapValue("sDtCalculo", ::csDtCalculo, csDtCalculo , "string", .F. , .F., 0 , NIL, .F.,.F.) 
cSoap += WSSoapValue("strVerificaRestricao", ::cstrVerificaRestricao, cstrVerificaRestricao , "string", .F. , .F., 0 , NIL, .F.,.F.) 
cSoap += "</calcPrazoNovo>"

oXmlRet := SvcSoapCall(Self,cSoap,; 
	"http://tempuri.org/calcPrazoNovo",; 
	"DOCUMENT","http://tempuri.org/",,,; 
	"http://ws.correios.com.br/calculador/calcprecoprazo.asmx")

::Init()
::oWScalcPrazoNovoResult:SoapRecv( WSAdvValue( oXmlRet,"_CALCPRAZONOVORESPONSE:_CALCPRAZONOVORESULT","cResultado",NIL,NIL,NIL,NIL,NIL,NIL) )
